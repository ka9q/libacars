% libacars(SECTION) | User Commands
%
% "May 10 2026"
...
libacars - program to do something

# SYNOPSIS

**libacars** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**libacars** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **libacars** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**libacars** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    libacars. See **foo.conf**(5) for further details.
...
**libacars** provides some return codes, that can be used in scripts:
